...
;; Given FN and a list, produce a filtered list that matches FN 

;; Tests:

(check-expect (filter2 positive? empty) empty)
(check-expect (filter2 negative? (list -1 1 2 3)) (list -1))
(check-expect (filter2 positive? (list -1 1 2 3)) (list 1 2 3))
